...
from custom_gemini.generative_model import generate_clean_image_response
...
class TestGenerativeModelFunctions(unittest.TestCase):
    ...
    def test_generate_clean_image_response(self, mock_open, mock_model):
        # Mock de la respuesta del modelo
        mock_response = MagicMock()
        ...
        result = generate_clean_image_response(prompt, images)
    ...
    def test_generate_clean_audio_response(self, mock_upload_file, mock_model):
        ...
        result = generate_clean_audio_response(prompt, audio_path)
